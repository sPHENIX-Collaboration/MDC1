...
my %topdcachehash = ();
#$topdcachehash{"/pnfs/rcf.bnl.gov/phenix/sphenixraw/MDC1/pythia8_pp/G4Hits"} = 1;
$topdcachehash{"/pnfs/rcf.bnl.gov/sphenix/disk/MDC1/pythia8_pp/G4Hits"} = 1;
#my $topdcachedir = "/pnfs/rcf.bnl.gov/phenix/sphenixraw/MDC1/pythia8_pp/G4Hits";
#my $topdcachedir = "/pnfs/rcf.bnl.gov/sphenix/disk/MDC1/pythia8_pp/G4Hits";

my $fmrange = "pythia8_pp";
