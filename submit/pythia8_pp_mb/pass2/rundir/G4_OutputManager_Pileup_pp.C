#ifndef MACRO_G4OUTPUTMANAGERPP_C
#define MACRO_G4OUTPUTMANAGERPP_C
...
void CreateDstOutput(int runnumber, int segment)
{
  ...
  string FullOutFile = DstOut::OutputDir + "/" + "DST_BBC_G4HIT_pythia8_mb-" + segrun + ".root";;
  ...
  FullOutFile = DstOut::OutputDir + "/" + "DST_TRKR_G4HIT_pythia8_mb-" + segrun + ".root";;
  ...
  FullOutFile = DstOut::OutputDir + "/" + "DST_CALO_G4HIT_pythia8_mb-" + segrun + ".root";;
  ...
  FullOutFile = DstOut::OutputDir + "/" + "DST_TRUTH_G4HIT_pythia8_mb-" + segrun + ".root";;
  ...
  FullOutFile = DstOut::OutputDir + "/" + "DST_VERTEX_pythia8_mb-" + segrun + ".root";;
