...
void CreateDstOutput(int runnumber, int segment)
{
  ...
  string FullOutFile = "DST_BBC_G4HIT_sHijing_0_20fm-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_TRKR_G4HIT_sHijing_0_20fm-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_CALO_G4HIT_sHijing_0_20fm-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_TRUTH_G4HIT_sHijing_0_20fm-" + string(segrun) + ".root";;
  ...
  FullOutFile = "DST_VERTEX_sHijing_0_20fm-" + string(segrun) + ".root";;
