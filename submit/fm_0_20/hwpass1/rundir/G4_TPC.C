...
namespace G4TPC
{
  ...
  auto static_distortion_filename = std::string("/phenix/u/hpereira/sphenix/work/g4simulations/distortion_maps/static_distortions_empty.root");
  ...
  std::string time_ordered_distortion_filename = "/phenix/u/hpereira/sphenix/work/g4simulations/distortion_maps/time_ordered_distortions_empty.root";
...
//     PHG4TpcElectronDrift::COORD_Z;
  ...
  auto correction_filename = std::string("/phenix/u/hpereira/sphenix/work/g4simulations/distortion_maps_rec/distortion_corrections_empty.root");
...
void TPC_Clustering()
{
  ...
  tpcclustercleaner->Verbosity(0);
  se->registerSubsystem(tpcclustercleaner);

  // Apply static SC distortion corrections in pass1
