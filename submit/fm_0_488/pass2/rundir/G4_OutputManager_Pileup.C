...
void CreateDstOutput(int runnumber, int segment)
{
  ...
  string FullOutFile = DstOut::OutputDir + "/" + "DST_BBC_G4HIT_sHijing_0_488fm-" + segrun + ".root";;
  ...
  FullOutFile = DstOut::OutputDir + "/" + "DST_TRKR_G4HIT_sHijing_0_488fm-" + segrun + ".root";;
  ...
  FullOutFile = DstOut::OutputDir + "/" + "DST_CALO_G4HIT_sHijing_0_488fm-" + segrun + ".root";;
  ...
  FullOutFile = DstOut::OutputDir + "/" + "DST_TRUTH_G4HIT_sHijing_0_488fm-" + segrun + ".root";;
  ...
  FullOutFile = DstOut::OutputDir + "/" + "DST_VERTEX_sHijing_0_488fm-" + segrun + ".root";;
