...
my %topdcachehash = ();
#$topdcachehash{"/pnfs/rcf.bnl.gov/phenix/sphenixraw/MDC1/sHijing_HepMC/Tracks"} = 1;
$topdcachehash{"/pnfs/rcf.bnl.gov/sphenix/disk/MDC1/sHijing_HepMC/Tracks"} = 1;

my $fmrange = "0_488fm_50kHz_bkg_0_20";
