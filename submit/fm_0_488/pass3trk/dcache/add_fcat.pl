...
my %topdcachehash = ();
#$topdcachehash{"/pnfs/rcf.bnl.gov/phenix/sphenixraw/MDC1/sHijing_HepMC/TrkrCluster"} = 1;
$topdcachehash{"/pnfs/rcf.bnl.gov/sphenix/disk/MDC1/sHijing_HepMC/TrkrCluster"} = 1;
