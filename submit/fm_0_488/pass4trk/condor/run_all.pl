...
my $getfiles = $dbh->prepare("select filename from datasets where dsttype = 'DST_TRKR_CLUSTER' and filename like '%sHijing_0_488fm%' order by filename") || die $DBI::error;
